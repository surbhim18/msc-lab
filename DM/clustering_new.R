...
d5 <- matrix(c(runif(num[5],-3,5),runif(num[5],15,22)),num[5],2)


xmin <- min(d1[,1],d2[,1],d3[,1],d4[,1],d5[,1])
xmax <- max(d1[,1],d2[,1],d3[,1],d4[,1],d5[,1])
ymin <- min(d1[,2],d2[,2],d3[,2],d4[,2],d5[,2])
ymax <- max(d1[,2],d2[,2],d3[,2],d4[,2],d5[,2])
